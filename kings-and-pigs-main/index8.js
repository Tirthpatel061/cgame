    ...
    enterDoor: {
      ...
      onComplete: () => {
        ...
        gsap.to(overlay, {
          ...
          onComplete: () => {
            if (level === 1) {
              // If the player enters the door, redirect to indexgame8.html (advanced game)
              window.location.href = "indexgame8.html"; // Navigate to advanced game
            } else {
              level++;
              if (level === 4) level = 1;
              levels[level].init();
